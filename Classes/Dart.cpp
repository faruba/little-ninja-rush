...
Dart* Dart::dart(const std::string& shap, cocos2d::Point pos, cocos2d::Point dir, int typ, Node* parent)
{
...
{
	blocked = false;
	mSprite = cocos2d::Sprite::createWithSpriteFrameName(mShap.c_str());
