...
void Scene2::createScene(cocos2d::Node * bg, Node * fbg, Node * fg, RingTile * tiles) 
{
    mTiles = tiles;
...
cocos2d::Sprite *sun = cocos2d::Sprite::createWithSpriteFrameName("s2_sun.png");
    sun->setPosition(cocos2d::Vec2(433, 300));
    mBg->addChild(sun, 1);
    //1
    mDynBg[0] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg3.png");
    mDynBg[0]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[0]->setPosition(cocos2d::Vec2(0, 110));
    mBg->addChild(mDynBg[0], 2);
    mDynBg[1] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg3.png");
    mDynBg[1]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[1]->setPosition(cocos2d::Vec2(mDynBg[0]->getContentSize().width, 110));
    mBg->addChild(mDynBg[1], 2);
    mDynBg[2] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg3.png");
    mDynBg[2]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[2]->setPosition(cocos2d::Vec2(mDynBg[0]->getContentSize().width*2, 110));
    mBg->addChild(mDynBg[2], 2);
    //2
    mDynBg[3] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg2.png");
    mDynBg[3]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[3]->setPosition(cocos2d::Vec2(0, 90));
    mBg->addChild(mDynBg[3], 3);
    mDynBg[4] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg2.png");
    mDynBg[4]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[4]->setPosition(cocos2d::Vec2(mDynBg[3]->getContentSize().width, 90));
    mBg->addChild(mDynBg[4], 3);
    mDynBg[5] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg2.png");
    mDynBg[5]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[5]->setPosition(cocos2d::Vec2(mDynBg[3]->getContentSize().width*2, 90));
    mBg->addChild(mDynBg[5], 3);
    //3
    mDynBg[6] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg1.png");
    mDynBg[6]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[6]->setPosition(cocos2d::Vec2(0, 80));
    mBg->addChild(mDynBg[6], 4);
    mDynBg[7] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg1.png");
    mDynBg[7]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[7]->setPosition(cocos2d::Vec2(mDynBg[6]->getContentSize().width, 80));
    mBg->addChild(mDynBg[7], 4);
    mDynBg[8] = cocos2d::Sprite::createWithSpriteFrameName("s2_bg1.png");
    mDynBg[8]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[8]->setPosition(cocos2d::Vec2(mDynBg[6]->getContentSize().width*2, 80));
    mBg->addChild(mDynBg[8], 4);
    //4
    mDynBg[9] = cocos2d::Sprite::createWithSpriteFrameName("s2_front.png");
    mDynBg[9]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[9]->setPosition(cocos2d::Vec2(0, 0));
    mFront->addChild(mDynBg[9], 0);
    mDynBg[10] = cocos2d::Sprite::createWithSpriteFrameName("s2_front.png");
    mDynBg[10]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[10]->setPosition(cocos2d::Vec2(mDynBg[9]->getContentSize().width, 0));
    mFront->addChild(mDynBg[10], 0);
    mDynBg[11] = cocos2d::Sprite::createWithSpriteFrameName("s2_front.png");
    mDynBg[11]->setAnchorPoint(cocos2d::Vec2(0, 0));
    mDynBg[11]->setPosition(cocos2d::Vec2(mDynBg[9]->getContentSize().width*2, 0));
    ...
    mLight->setAnchorPoint(cocos2d::Vec2(0.5f, 1));
    mLight->setRotation(30);
    mLight->setPosition(cocos2d::Vec2(3*UniversalFit::sharedUniversalFit()->playSize.width, 215));
    ...
    for( int i=0; i<4; i++)
    {
        ...
        mUpbg[i]->setAnchorPoint(cocos2d::Vec2(0, 0));
        mUpbg[i]->setPosition(cocos2d::Vec2(mUpbg[i]->getContentSize().width*i, 242));
...
void Scene2::update(float delta) 
{
  ...
  for( int i=0; i<4; ++i)
  {
    mUpbg[i]->setPosition(cocos2d::Vec2(-doff+dr*i, 242));
  }

  woff = mTiles->offset()/4;
  dr = mDynBg[0]->getContentSize().width;
  doff = woff%dr;
  mDynBg[0]->setPosition(cocos2d::Vec2(-doff, 110));
  mDynBg[1]->setPosition(cocos2d::Vec2(-doff+mDynBg[0]->getContentSize().width, 110));
  mDynBg[2]->setPosition(cocos2d::Vec2(-doff+mDynBg[0]->getContentSize().width*2, 110));
  woff = mTiles->offset()/3;
  dr = mDynBg[3]->getContentSize().width;
  doff = woff%dr;
  mDynBg[3]->setPosition(cocos2d::Vec2(-doff, 90));
  mDynBg[4]->setPosition(cocos2d::Vec2(-doff+mDynBg[3]->getContentSize().width, 90));
  mDynBg[5]->setPosition(cocos2d::Vec2(-doff+mDynBg[3]->getContentSize().width*2, 90));
  woff = mTiles->offset()/2;
  dr = mDynBg[4]->getContentSize().width;
  doff = woff%dr;
  mDynBg[6]->setPosition(cocos2d::Vec2(-doff, 80));
  mDynBg[7]->setPosition(cocos2d::Vec2(-doff+mDynBg[6]->getContentSize().width, 80));
  mDynBg[8]->setPosition(cocos2d::Vec2(-doff+mDynBg[6]->getContentSize().width*2, 80));
  woff = mTiles->offset()*2;
  dr = mDynBg[6]->getContentSize().width;
  doff = woff%dr;
  mDynBg[9]->setPosition(cocos2d::Vec2(-doff, 0));
  mDynBg[10]->setPosition(cocos2d::Vec2(-doff+mDynBg[9]->getContentSize().width, 0));
  mDynBg[11]->setPosition(cocos2d::Vec2(-doff+mDynBg[9]->getContentSize().width*2, 0));
  ...
  //重新计算光照角度
  cocos2d::Point dis = ccpNormalize(ccpSub(cocos2d::Vec2(443, 300), mLight->getPosition()));
