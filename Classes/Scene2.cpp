...
cocos2d::CCSprite *sun = cocos2d::CCSprite::createWithSpriteFrameName("s2_sun.png");
    ...
    mBg->addChild(sun, 1);
    //1
    mDynBg[0] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg3.png");
    mDynBg[0]->setAnchorPoint(cocos2d::ccp(0, 0));
    mDynBg[0]->setPosition(cocos2d::ccp(0, 110));
    mBg->addChild(mDynBg[0], 2);
    mDynBg[1] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg3.png");
    ...
    mDynBg[2] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg3.png");
    ...
    //2
    mDynBg[3] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg2.png");
    mDynBg[3]->setAnchorPoint(cocos2d::ccp(0, 0));
    mDynBg[3]->setPosition(cocos2d::ccp(0, 90));
    mBg->addChild(mDynBg[3], 3);
    mDynBg[4] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg2.png");
    ...
    mDynBg[5] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg2.png");
    ...
    //3
    mDynBg[6] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg1.png");
    mDynBg[6]->setAnchorPoint(cocos2d::ccp(0, 0));
    mDynBg[6]->setPosition(cocos2d::ccp(0, 80));
    mBg->addChild(mDynBg[6], 4);
    mDynBg[7] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg1.png");
    ...
    mDynBg[8] = cocos2d::CCSprite::createWithSpriteFrameName("s2_bg1.png");
    ...
    //4
    mDynBg[9] = cocos2d::CCSprite::createWithSpriteFrameName("s2_front.png");
    mDynBg[9]->setAnchorPoint(cocos2d::ccp(0, 0));
    mDynBg[9]->setPosition(cocos2d::ccp(0, 0));
    mFront->addChild(mDynBg[9], 0);
    mDynBg[10] = cocos2d::CCSprite::createWithSpriteFrameName("s2_front.png");
    ...
    mDynBg[11] = cocos2d::CCSprite::createWithSpriteFrameName("s2_front.png");
    ...
    //增加光照
    mLight = cocos2d::CCSprite::createWithSpriteFrameName("s2_light.png");
    ...
    for( int i=0; i<4; i++)
    {
        mUpbg[i] = cocos2d::CCSprite::createWithSpriteFrameName("s2_ubg.png");
